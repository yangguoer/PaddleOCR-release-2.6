...
# 提取除了第一个参数之外的所有参数
shift
python_args1="-c configs/rec/PP-OCRv3/ch_PP-OCRv3_rec.yml -o Global.pretrained_model=./pretrain_models/ch_PP-OCRv3_rec_train/best_accuracy_new"

shift
python_args2="-c configs/rec/PP-OCRv3/ch_PP-OCRv3_rec.yml -o Global.pretrained_model=./output/rec_ppocr_v3/latest  Global.save_inference_dir=./output/rec_inference/"

echo "执行ocr文字识别训练文件: $python_file1"
...
echo "ocr文字识别训练文件执行结果:"
echo "$python_output1"

echo "执行ocr文字识别模型导出文件: $python_file2"
